...
type Sum struct {
	Number []int32 `protobuf:"varint,1,rep,packed,name=number" json:"number,omitempty"`
}

func (m *Sum) Reset()                    { *m = Sum{} }
func (m *Sum) String() string            { return proto.CompactTextString(m) }
func (*Sum) ProtoMessage()               {}
func (*Sum) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }

func (m *Sum) GetNumber() []int32 {
	if m != nil {
		return m.Number
	}
	return nil
...
type SumRequest struct {
	Summing *Sum `protobuf:"bytes,1,opt,name=summing" json:"summing,omitempty"`
}
...
func (m *SumRequest) GetSumming() *Sum {
	if m != nil {
		return m.Summing
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
